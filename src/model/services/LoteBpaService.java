...
public class LoteBpaService {
    ...
    public List<LoteBpa> findAll() {
        ...
        list.add(new LoteBpa(1, data, new Profissional(1, "Evandio Pereira", 1, "SUPERIOR", "PROGRAMADOR"),10, 1));
        list.add(new LoteBpa(2, data, new Profissional(2, "Antonio", 1, "SUPERIOR", "ENFERMEIRO"), 4,  1));
        list.add(new LoteBpa(3, data, new Profissional(3, "Pereira", 1, "SUPERIOR", "ANALISTA"), 6, 1));
